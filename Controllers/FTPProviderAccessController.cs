...
namespace EJ2APIServices.Controllers
{
    ...
    public class FTPProviderAccessController : Controller
    {
        public FTPFileProvider operation;
        public FTPProviderAccessController(IWebHostEnvironment hostingEnvironment)
        {
            this.operation = new FTPFileProvider();
            //Specify the FTP hostname, username and password
            this.operation.SetFTPConnection("ftp://172.20.10.3/", "<-username->", "<-password->");
